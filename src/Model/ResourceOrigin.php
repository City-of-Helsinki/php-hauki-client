 ...
 */
class ResourceOrigin implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResourceOrigin';
    ...
    public function setOriginId($origin_id)
    {
        if ((mb_strlen($origin_id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $origin_id when calling ResourceOrigin., must be smaller than or equal to 100.');
        }
