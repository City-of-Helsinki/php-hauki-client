...
class Resource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Resource., must be smaller than or equal to 255.');
        }
     ...
     *
     * @param User $last_modified_by last_modified_by
     *
     * @return self
     */
