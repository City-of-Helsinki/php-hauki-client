...
/**
 * PeriodOrigin Class Doc Comment
 *
 * @category Class
 * @package  Hauki
 * @author   OpenAPI Generator team
 ...
 */
class PeriodOrigin implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PeriodOrigin';
    ...
    protected static $openAPITypes = [
        'data_source' => '\Hauki\Model\DataSource',
        'origin_id' => 'string'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['origin_id']) > 100)) {
     ...
     * Sets data_source
     *
     * @param \Hauki\Model\DataSource $data_source data_source
     *
     * @return self
     */
    ...
    {
        if ((mb_strlen($origin_id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $origin_id when calling PeriodOrigin., must be smaller than or equal to 100.');
        }
