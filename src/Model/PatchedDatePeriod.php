...
/**
 * PatchedDatePeriod Class Doc Comment
 *
 * @category Class
 ...
 */
class PatchedDatePeriod implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedDatePeriod';
     ...
     * Sets resource
     *
     * @param int|null $resource resource
     *
     * @return self
     */
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchedDatePeriod., must be smaller than or equal to 255.');
        }
